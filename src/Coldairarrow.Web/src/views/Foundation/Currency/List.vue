          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="Symbol">Symbol</a-select-option>
                <a-select-option key="Sign">Sign</a-select-option>
...
const columns = [
  ...
  { title: 'Symbol', dataIndex: 'Symbol', width: '10%' },
  { title: 'Sign', dataIndex: 'Sign', width: '10%' },
  { title: 'IsAvailable', dataIndex: 'IsAvailable', width: '10%' },
  { title: 'DecimalDigit', dataIndex: 'DecimalDigit', width: '10%' },
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      this.loading = true
      this.$http
        .post('/Foundation/Currency/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk () {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/Foundation/Currency/DeleteData', ids).then(resJson => {
              resolve()
